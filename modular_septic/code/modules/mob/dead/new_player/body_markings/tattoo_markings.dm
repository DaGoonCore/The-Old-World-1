...
/datum/body_marking/tattoo
	icon = 'oworld/icons/mob/human/body_markings/tattoo/tattoo_markings.dmi'
...
/datum/body_marking/tattoo/heart
	name = "Tattoo - Heart"
	icon = 'oworld/icons/mob/human/body_markings/tattoo/heart.dmi'
	icon_state = "tat_heart"
	affected_bodyparts = CHEST|ARM_LEFT|ARM_RIGHT

/datum/body_marking/tattoo/hive
	name = "Tattoo - Hive"
	icon = 'oworld/icons/mob/human/body_markings/tattoo/hive.dmi'
	icon_state = "tat_hive"
...
/datum/body_marking/tattoo/nightling
	...
	icon = 'oworld/icons/mob/human/body_markings/tattoo/nightling.dmi'
...
/datum/body_marking/tattoo/silverburgh //dunno what this is.
	...
	icon = 'oworld/icons/mob/human/body_markings/tattoo/silverburgh.dmi'
