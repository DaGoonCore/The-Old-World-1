...
/mob/proc/perform_zoom(atom/A, params, silent = FALSE)
	...
	if(!silent)
		playsound_local(src, 'oworld/sound/interface/zoom_in.wav', 25, FALSE, pressure_affected = FALSE)
...
/mob/proc/unperform_zoom(atom/A, params, silent = FALSE)
	...
	if(!silent)
		playsound_local(src, 'oworld/sound/interface/zoom_out.wav', 25, FALSE, pressure_affected = FALSE)
