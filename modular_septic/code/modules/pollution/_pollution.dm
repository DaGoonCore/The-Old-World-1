...
/datum/pollution/proc/get_overlay(list/pollutant_list, total_amount)
	...
	var/mutable_appearance/overlay = mutable_appearance('oworld/icons/effects/pollution/pollution.dmi', "smoke", FLY_LAYER, POLLUTION_PLANE, appearance_flags = KEEP_APART | RESET_TRANSFORM | RESET_COLOR)
	overlay.pixel_x = -32
	overlay.pixel_y = -32
