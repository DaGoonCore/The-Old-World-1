/obj/item/gun/ballistic/revolver
	icon = 'oworld/icons/obj/items/guns/revolver.dmi'
	icon_state = "revolver"
	...
	lock_back_sound = 'oworld/sound/weapons/guns/revolver/cylinder_in.wav'
	// open cylinder sound
	bolt_drop_sound = 'oworld/sound/weapons/guns/revolver/cylinder_out.wav'
	load_sound = 'oworld/sound/weapons/guns/revolver/load_bullet.wav'
	eject_sound = 'oworld/sound/weapons/guns/revolver/revolver_eject.wav'
	...
	fire_sound = 'oworld/sound/weapons/guns/revolver/revolver_fire.ogg'
	alternative_fire_sound = 'oworld/sound/weapons/guns/revolver/revolver_fire.ogg'
	...
	dry_fire_sound = 'oworld/sound/weapons/guns/revolver/empty_revolver.wav'
...
/obj/item/gun/ballistic/revolver/remis/gado
	...
	fire_sound = list('oworld/sound/weapons/guns/revolver/gado1.wav', 'oworld/sound/weapons/guns/revolver/gado3.wav', 'oworld/sound/weapons/guns/revolver/gado3.wav')
	safety_on_sound = 'oworld/sound/weapons/guns/revolver/gado_safetyon.ogg'
	safety_off_sound = 'oworld/sound/weapons/guns/revolver/gado_safetyoff.ogg'
	lock_back_sound = 'oworld/sound/weapons/guns/revolver/gado_in.wav'
	// open cylinder sound
	bolt_drop_sound = 'oworld/sound/weapons/guns/revolver/gado_out.wav'
	// hammer sound
	rack_sound = 'oworld/sound/weapons/guns/revolver/gado_hammer.wav'
	gunshot_animation_information = list(
		"pixel_x" = 13, \
		"pixel_y" = 3, \
	)
...
/obj/item/gun/ballistic/revolver/remis/nova
	...
	fire_sound = 'oworld/sound/weapons/guns/revolver/nova.wav'
	alternative_fire_sound = 'oworld/sound/weapons/guns/revolver/nova_alt.wav'
...
/obj/item/gun/ballistic/revolver/remis/poppy
	...
	fire_sound = 'oworld/sound/weapons/guns/revolver/bigboy.wav'
	alternative_fire_sound = 'oworld/sound/weapons/guns/revolver/bigboy.wav'
	lock_back_sound = 'oworld/sound/weapons/guns/revolver/bigboy_in.wav'
	bolt_drop_sound = 'oworld/sound/weapons/guns/revolver/bigboy_out.wav'
	rack_sound = 'oworld/sound/weapons/guns/revolver/bigboy_hammer.wav'
	gunshot_animation_information = list(
		"pixel_x" = 13, \
		"pixel_y" = 3, \
	)
