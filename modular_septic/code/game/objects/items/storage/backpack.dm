/obj/item/storage/backpack
	...
	pickup_sound = 'oworld/sound/armor/equip/backpack_pickup.wav'
	drop_sound = 'oworld/sound/armor/equip/backpack_drop.wav'
	equip_sound = 'oworld/sound/armor/equip/backpack_wear.wav'

/obj/item/storage/backpack/Initialize()
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
	if(STR)
		STR.rustle_sound = 'oworld/sound/armor/equip/backpack_use.wav'
...
/obj/item/storage/backpack/leather
	icon = 'oworld/icons/obj/clothing/back.dmi'
	icon_state = "leather_backpack"
	worn_icon = 'oworld/icons/mob/clothing/back.dmi'
