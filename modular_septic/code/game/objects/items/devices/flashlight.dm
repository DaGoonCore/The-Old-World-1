/obj/item/flashlight/flare
	pickup_sound = 'oworld/sound/effects/flare_prepare.wav'
...
/obj/item/flashlight/flare/process(delta_time)
	...
	if((fuel <= 0) || !on)
		turn_off()
		playsound(src, 'oworld/sound/effects/flare_end.wav', 90, FALSE)
		if(!fuel)
...
/obj/item/flashlight/flare/attack_self(mob/user)
	...
	if(.)
		...
		playsound(src, 'oworld/sound/effects/flare_start.wav', 90, FALSE)
		soundloop.start()
		force = on_damage
		damtype = BURN
