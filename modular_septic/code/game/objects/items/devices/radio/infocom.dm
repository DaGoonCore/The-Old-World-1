...
/obj/machinery/infocom
	...
	density = FALSE
	var/radiotune = list('oworld/sound/efn/infocom1.ogg', 'oworld/sound/efn/infocom2.ogg', 'oworld/sound/efn/infocom3.ogg', 'oworld/sound/efn/infocom4.ogg')
	var/virused = FALSE
	var/tip_sound = 'oworld/sound/efn/infocom_trigger.ogg'
	var/untip_sound = 'oworld/sound/efn/infocom_untrigger.ogg'
...
/obj/machinery/infocom/combat
	...
	radiotune = list('oworld/sound/efn/evilcom1.ogg', 'oworld/sound/efn/evilcom2.ogg', 'oworld/sound/efn/evilcom3.ogg')
