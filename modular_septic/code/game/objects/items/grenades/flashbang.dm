/obj/item/grenade/flashbang
	...
	drop_sound = list('oworld/sound/weapons/flash1.wav', 'oworld/sound/weapons/flash2.wav')
...
/obj/item/grenade/flashbang/detonate(mob/living/lanced_by)
	...
	playsound(flashbang_turf, 'oworld/sound/weapons/flashBANG.ogg', 100, TRUE, 8, 0.9)
