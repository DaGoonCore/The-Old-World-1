...
/datum/component/babble
	...
	var/babble_sound_male = 'oworld/sound/voice/babble/babble_male.wav'
	var/babble_sound_female = 'oworld/sound/voice/babble/babble_female.wav'
	var/babble_sound_agender = 'oworld/sound/voice/babble/babble_agender.wav'
...
/datum/component/babble/Initialize(babble_sound_override, \
								babble_sound_male = 'oworld/sound/voice/babble/babble_male.wav', \
								babble_sound_female = 'oworld/sound/voice/babble/babble_female.wav', \
								babble_sound_agender = 'oworld/sound/voice/babble/babble_agender.wav', \
