...
/datum/component/storage/proc/generate_bound_underlay(tetris_width = 32, tetris_height = 32)
	var/mutable_appearance/bound_underlay = mutable_appearance(icon = 'oworld/icons/hud/quake/storage.dmi', appearance_flags = RESET_ALPHA|RESET_COLOR|RESET_TRANSFORM|KEEP_APART)
