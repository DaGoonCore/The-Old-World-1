/obj/machinery/door/metal_door/wood_door
	...
	icon = 'oworld/icons/obj/structures/wood_door.dmi'
	base_icon_state = "wood"
	icon_state = "wood"
	doorOpen = 'oworld/sound/doors/wood/door_wooden_open.ogg'
	doorClose = 'oworld/sound/doors/wood/door_wooden_close.ogg'
	doorDeni = 'oworld/sound/doors/wood/door_wooden_try.ogg'
	kickfailure = list('oworld/sound/doors/wood/door_wooden_kickfail1.ogg', 'oworld/sound/doors/wood/door_wooden_kickfail2.ogg')
	kicksuccess = 'oworld/sound/doors/wood/door_wooden_kicksuccess.ogg'
	kickcriticalsuccess = 'oworld/sound/doors/smod_freeman_extreme.ogg'
