...
/obj/item/knife/combat/zhunter
	...
	icon = 'oworld/icons/obj/items/melee/knife.dmi'
	icon_state = "zhunter"
	min_force = 3
	force = 10
...
/obj/item/melee/truncheon
	...
	icon = 'oworld/icons/obj/items/melee/baton.dmi'
	icon_state = "truncheon"
	lefthand_file = 'oworld/icons/obj/items/melee/inhands/baton_lefthand.dmi'
	righthand_file = 'oworld/icons/obj/items/melee/inhands/baton_righthand.dmi'
	inhand_icon_state = "truncheon"
	drop_sound = list('oworld/sound/weapons/melee/baton_fall1.wav', 'oworld/sound/weapons/melee/baton_fall2.wav')
	miss_sound = list('oworld/sound/weapons/melee/baton_swish1.wav', 'oworld/sound/weapons/melee/baton_swish2.wav', 'oworld/sound/weapons/melee/baton_swish3.wav')
	hitsound = list('oworld/sound/weapons/melee/baton1.wav', 'oworld/sound/weapons/melee/baton2.wav', 'oworld/sound/weapons/melee/baton3.wav')
	min_force = 3
	force = 5
...
/obj/item/lead_pipe
	...
	icon = 'oworld/icons/obj/items/melee/pipe.dmi'
...
/obj/item/changeable_attacks
	...
	var/slash_hitsound = list('oworld/sound/weapons/melee/kukri1.wav', 'oworld/sound/weapons/melee/kukri2.wav', 'oworld/sound/weapons/melee/kukri3.wav')
	var/stab_hitsound = list('oworld/sound/weapons/melee/sharp_stab1.ogg', 'oworld/sound/weapons/melee/sharp_stab2.ogg')
	var/bash_hitsound = list('oworld/sound/weapons/melee/baton1.wav', 'oworld/sound/weapons/melee/baton2.wav', 'oworld/sound/weapons/melee/baton3.wav')
...
/obj/item/changeable_attacks/proc/swap_intents(mob/user)
	if(isnull(current_atk_mode))
		...
		return
	user.playsound_local(get_turf(src), 'oworld/sound/weapons/melee/swap_intent.ogg', 5, FALSE)
...
/obj/item/changeable_attacks/sword
	...
	icon = 'oworld/icons/obj/items/melee/knife.dmi'
	lefthand_file = 'oworld/icons/obj/items/melee/inhands/knife_lefthand.dmi'
	righthand_file = 'oworld/icons/obj/items/melee/inhands/knife_righthand.dmi'
	worn_icon = 'oworld/icons/obj/items/melee/worn/knife_worn.dmi'
	equip_sound = 'oworld/sound/weapons/melee/kukri_holster.wav'
	pickup_sound = 'oworld/sound/weapons/melee/kukri_deploy.wav'
	miss_sound = list('oworld/sound/weapons/melee/kukri_swish1.wav', 'oworld/sound/weapons/melee/kukri_swish2.wav', 'oworld/sound/weapons/melee/kukri_swish3.wav')
	drop_sound = list('oworld/sound/weapons/melee/bladedrop1.wav', 'oworld/sound/weapons/melee/bladedrop2.wav')
...
/obj/item/changeable_attacks/skindeep
	...
	icon = 'oworld/icons/obj/items/melee/48x32.dmi'
	lefthand_file = 'oworld/icons/obj/items/melee/inhands/sword_lefthand.dmi'
	righthand_file = 'oworld/icons/obj/items/melee/inhands/sword_righthand.dmi'
	icon_state = "skin_cleaver"
	inhand_icon_state = "skin_cleaver"
	current_atk_mode = slash
	slash_hitsound = list('oworld/sound/weapons/melee/heavysharp_slash1.ogg', 'oworld/sound/weapons/melee/heavysharp_slash2.ogg', 'oworld/sound/weapons/melee/heavysharp_slash3.ogg')
	pickup_sound = 'oworld/sound/weapons/melee/heavysharp_deploy.ogg'
	miss_sound = list('oworld/sound/weapons/melee/heavysharp_swish1.ogg', 'oworld/sound/weapons/melee/heavysharp_swish2.ogg', 'oworld/sound/weapons/melee/heavysharp_swish3.ogg')
	drop_sound = list('oworld/sound/weapons/melee/bladedrop1.wav', 'oworld/sound/weapons/melee/bladedrop2.wav')
	min_force = 13
	force = 25
...
/obj/item/kukri
	...
	righthand_file = 'oworld/icons/obj/items/melee/inhands/knife_righthand.dmi'
	worn_icon = 'oworld/icons/obj/items/melee/worn/knife_worn.dmi'
	hitsound = list('oworld/sound/weapons/melee/kukri1.wav', 'oworld/sound/weapons/melee/kukri2.wav', 'oworld/sound/weapons/melee/kukri3.wav')
	equip_sound = 'oworld/sound/weapons/melee/kukri_holster.wav'
	pickup_sound = 'oworld/sound/weapons/melee/kukri_deploy.wav'
	miss_sound = list('oworld/sound/weapons/melee/kukri_swish1.wav', 'oworld/sound/weapons/melee/kukri_swish2.wav', 'oworld/sound/weapons/melee/kukri_swish3.wav')
	drop_sound = list('oworld/sound/weapons/melee/bladedrop1.wav', 'oworld/sound/weapons/melee/bladedrop2.wav')
...
/obj/item/skin_cleaver
	...
	inhand_icon_state = "skin_cleaver"
	slot_flags = null
	hitsound = list('oworld/sound/weapons/melee/heavysharp_slash1.ogg', 'oworld/sound/weapons/melee/heavysharp_slash2.ogg', 'oworld/sound/weapons/melee/heavysharp_slash3.ogg')
	pickup_sound = 'oworld/sound/weapons/melee/heavysharp_deploy.ogg'
	miss_sound = list('oworld/sound/weapons/melee/heavysharp_swish1.ogg', 'oworld/sound/weapons/melee/heavysharp_swish2.ogg', 'oworld/sound/weapons/melee/heavysharp_swish3.ogg')
	drop_sound = list('oworld/sound/weapons/melee/bladedrop1.wav', 'oworld/sound/weapons/melee/bladedrop2.wav')
	icon = 'oworld/icons/obj/items/melee/48x32.dmi'
