...
/datum/component/fixeye/proc/enable_fixeye(mob/living/source, silent = TRUE, forced = TRUE)
	...
	if(!silent)
		source.playsound_local(source, 'oworld/sound/interface/fixeye_on.wav', 25, FALSE, pressure_affected = FALSE)
	facedir = source.dir
...
/datum/component/fixeye/proc/disable_fixeye(mob/living/source, silent = TRUE, forced = TRUE)
	...
	if(!silent)
		source.playsound_local(source, 'oworld/sound/interface/fixeye_off.wav', 25, FALSE, pressure_affected = FALSE)
