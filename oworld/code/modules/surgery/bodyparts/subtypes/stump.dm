/obj/item/bodypart/stump
	...
	render_icon = 'oworld/icons/mob/human/overlays/stump.dmi'
	no_update = TRUE
	gender_rendering = FALSE
	dismemberment_sounds = list('oworld/sound/gore/severed.ogg') // A stump Isn't that big, It's smaller then a regular limb so I give it a smaller sounding.
