/obj/item/gun/energy/remis/railgun
	...
	lefthand_file = 'oworld/icons/obj/items/guns/inhands/64x64_lefthand.dmi'
	righthand_file = 'oworld/icons/obj/items/guns/inhands/64x64_righthand.dmi'
	inhand_icon_state = "plasmarifle"
	wielded_inhand_state = TRUE
	inhand_x_dimension = 64
	inhand_y_dimension = 64
	equip_sound = 'oworld/sound/weapons/guns/weap_away.ogg'
	fire_sound = list('oworld/sound/weapons/guns/energy/railgun1.wav', 'oworld/sound/weapons/guns/energy/railgun2.wav', 'oworld/sound/weapons/guns/energy/railgun3.wav')
