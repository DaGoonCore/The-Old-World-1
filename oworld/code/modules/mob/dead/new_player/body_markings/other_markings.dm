...
/datum/body_marking/other
	icon = 'oworld/icons/mob/human/body_markings/other/other_markings.dmi'
	recommended_species = null

/datum/body_marking/other/drake_bone
	name = "Drake Bone"
	icon = 'oworld/icons/mob/human/body_markings/other/drakebone.dmi'
...
/datum/body_marking/other/tonage
	name = "Body Tonage"
	icon = 'oworld/icons/mob/human/body_markings/other/tonage.dmi'
	icon_state = "tonage"
...
/datum/body_marking/other/pilot
	name = "Pilot"
	icon = 'oworld/icons/mob/human/body_markings/other/pilot.dmi'
	icon_state = "pilot"
	default_color = "CCCCCC"
...
/datum/body_marking/other/pilot_jaw
	name = "Pilot Jaw"
	icon = 'oworld/icons/mob/human/body_markings/other/pilot_jaw.dmi'
...
/datum/body_marking/other/drake_eyes
	name = "Drake Eyes"
	icon = 'oworld/icons/mob/human/body_markings/other/drakeeyes.dmi'
