...
/obj/structure/chair/office
	...
	buckle_sound = 'oworld/sound/efn/chairs/chair_office_sit.ogg'
	unbuckle_sound = 'oworld/sound/efn/chairs/chair_office_standup.ogg'

/obj/structure/chair/office/Moved()
	. = ..()
	if(has_gravity())
		playsound(src, 'oworld/sound/efn/chairs/chair_office_move.ogg', 100, TRUE)
